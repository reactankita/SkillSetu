    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 space-y-6">
      ...
      <div className="space-y-1">
        ...
        <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
          Find verified student talent for your project, event, business or learning needs with payment protection.
        </p>
      </div>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3">
          <div className="relative flex-1 w-full">
            ...
            <Input
              ...
              className="pl-10 h-11 bg-slate-50/70 dark:bg-slate-800 border-slate-200 dark:border-slate-700 focus:bg-white dark:focus:bg-slate-900 text-sm"
            />
          </div>

          <div className="flex items-center gap-2 w-full sm:w-auto justify-between sm:justify-end">
            {/* Sort Dropdown */}
            <div className="flex items-center gap-1.5 text-xs text-slate-600 dark:text-slate-400 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2">
              ...
              >
                ...
                <option value="top_rated" className="dark:bg-slate-900">Top Rated</option>
                <option value="most_booked" className="dark:bg-slate-900">Most Booked</option>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-start">
        ...
        <div className="col-span-1 lg:col-span-3 space-y-4">
          <div className="flex items-center justify-between text-xs text-slate-500 dark:text-slate-400 font-semibold px-1">
            <span>
              Showing <strong className="text-slate-900 dark:text-slate-100">{filteredServices.length}</strong> verified student services
            </span>
          ...
          {filteredServices.length === 0 ? (
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-12 text-center space-y-4">
              ...
              <div className="space-y-1">
                <h3 className="text-base font-bold text-slate-900 dark:text-slate-100">No Services Found</h3>
